...
The active scene-specific behavior axes are defined in
`schema_v2.py`:
...
```bash
python -m research.style_scene_split.build_train_val_style_scene_split_v2
```
...
```bash
python -m research.style_scene_split.build_style_scene_split_v2
```
...
```bash
python -m research.style_scene_split.validate_style_scene_split_v2
python -m research.style_scene_split.analyze_style_scene_split_v2
```

## Legacy Compatibility

Legacy `v1` scripts are still kept so older outputs can be read or reproduced
without breaking prior experiments:

- `build_style_scene_split.py`
- `validate_style_scene_split.py`
- `analyze_style_scene_split.py`
