...
```bash
python -m research.preference_execution.calibration.build_calibration_dataset
```

Validate the resulting export:

```bash
python -m research.preference_execution.calibration.validate_calibration_dataset
```
