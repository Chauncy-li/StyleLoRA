...
```bash
python -m research.preference_execution.interaction_state.build_interaction_state_dataset \
...
```bash
python -m research.preference_execution.interaction_state.build_train_val_interaction_state
```

Validate an exported interaction-state dataset:

```bash
python -m research.preference_execution.interaction_state.validate_interaction_state_dataset \
