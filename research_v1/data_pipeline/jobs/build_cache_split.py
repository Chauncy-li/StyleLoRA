...
from research_v1.paths import DEFAULT_DATA_SPLITS_ROOT, DEFAULT_RECORD_ROOT, ensure_repo_on_path
...
def _forward_cache_train_val(argv: Sequence[str]) -> None:
    from research_v1.data_pipeline.cache_split import main as split_main
...
def _forward_test_simu(argv: Sequence[str]) -> None:
    ...
    from research_v1.data_pipeline.jobs import process_cache as process_module
